...
// ==== 分区：Progression（进度解锁：A/B 组锁定判断与强制复位）====
        ...
        //    - 建造增强-自由放置 (Builder Enhancements/Grid Override)
        //    - 树屋问号总开关 (实验/Question Mark)
        ...
        private static void ForceLockedConfigs() {
            try {
                ...
                if (!Experiments.IsProgressionUnlocked()) {
                    ...
                    ForceLocked("Builder Enhancements", "Grid Override");
                    ForceLocked("实验", "Question Mark");
                }
